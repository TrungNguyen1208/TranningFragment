...
import ptit.nttrung.tranningfragment.adapter.UserProfileAdapter;
import ptit.nttrung.tranningfragment.base.BaseDrawerActivity;
import ptit.nttrung.tranningfragment.custom.RevealBackgroundView;
import ptit.nttrung.tranningfragment.utils.CircleTransformation;
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.menu_settings:
                        Toast.makeText(UserProfileActivity.this, "blala", Toast.LENGTH_SHORT).show();
                        break;
